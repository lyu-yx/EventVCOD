...
from sam2.modeling.sam2_base_prompt_dense_fpn_emb_mem_dense_adp2_inf import SAM2Base
...
class SAM2TrainVCODPromptGenerator(SAM2Base):
    ...
    def _prepare_backbone_features_per_frame(self, img_batch, event_batch, img_ids):
        ...
        (
            ...
            vision_pos_embeds,
            feat_sizes,
        ) = self._prepare_backbone_features_vis(backbone_out_img)
        ...
        (
            ...
            feat_sizes_event,
        ) = self._prepare_backbone_features_event(backbone_out_event)
    ...
    def forward_tracking(
        ...
        if img_feats_already_computed:
            ...
            (
                ...
                vision_pos_embeds,
                feat_sizes,
            ) = self._prepare_backbone_features_vis(backbone_out)
