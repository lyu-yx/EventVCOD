...
from sam2.modeling.sam2_base_prompt_generator_visionfeat_gather_chg_feats_fusion_and_evt_twoenc import SAM2Base
...
class SAM2TrainVCODPromptGenerator(SAM2Base):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(image_encoder, event_encoder, memory_attention, short_long_relation_attention, feature_fusion, memory_encoder, **kwargs)
