...
class VCODDataset(VOSRawDataset):
    def __init__(
        self,
        img_folder,
        gt_folder,
...
class VCODDatasetMoCA(VOSRawDataset):
    def __init__(
        self,
        img_folder,
        gt_folder,
...
class COD10KDatasetwoEvent(VOSRawDataset):
    def __init__(
        self,
        img_folder,
        gt_folder,
    ...
    def get_video(self, idx):
        ...
        video = VOSVideowoEvent(video_name, idx, frames)
        return video, segment_loader
