...
from sam2.modeling.ablation.sam2_base_visual_embedding_generator import NO_OBJ_SCORE, SAM2Base
...
class SAM2VideoPredictor(SAM2Base):
    ...
    def from_pretrained(cls, model_id: str, **kwargs) -> "SAM2VideoPredictor":
        ...
        """
        from sam2.build_sam_ablation_visual_embedding import build_sam2_video_predictor_hf
