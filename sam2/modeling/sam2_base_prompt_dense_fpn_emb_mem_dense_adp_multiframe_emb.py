...
from sam2.modeling.sam.event_adaptor_complex import MultiLevelEventAdaptorAttention, EventAdaptorAttention
...
class SAM2Base(torch.nn.Module):
    ...
    def _build_sam_heads(self):
        ...
        self.high_res_event_features_adp=MultiLevelEventAdaptorAttention(in_channels_list=[32, 64], use_residual=True) # high res feat channel
        self.high_res_features_adp = MultiLevelEventAdaptorAttention(in_channels_list=[32, 64], use_residual=True) # high res feat channel
        
        self.pix_feat_adp = EventAdaptorAttention(256, use_residual=True)
        self.pix_feat_event_adp = EventAdaptorAttention(256, use_residual=True)
