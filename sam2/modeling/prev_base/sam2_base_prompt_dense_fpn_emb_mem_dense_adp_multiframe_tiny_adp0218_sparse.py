...
class SAM2Base(torch.nn.Module):
    ...
    def _forward_sam_heads(
        ...
        sparse_embeddings_gt, dense_embeddings_none = self.sam_prompt_encoder(
        ...
        sparse_embeddings, _ = self.embedding_generator(backbone_features, event_features, high_res_features, high_res_event_features, cur_video)# a) Handle point prompts
