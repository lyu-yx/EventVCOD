...
from sam2.modeling.sam2_base_prompt_dense_fpn_emb_mem_dense_adp2_inf import NO_OBJ_SCORE, SAM2Base
...
class SAM2VideoPredictor(SAM2Base):
    ...
    def _get_image_feature(self, inference_state, frame_idx, batch_size):
        ...
        features = self._prepare_backbone_features_vis(expanded_backbone_out)
    ...
    def _get_event_feature(self, inference_state, frame_idx, batch_size):
        ...
        features = self._prepare_backbone_features_event(expanded_backbone_out)
        features = (expanded_image,) + features
        return features
