...
from sam2.modeling.sam2_base_prompt_dense_fpn_emb_mem_dense_adp_multiframe_emb import NO_OBJ_SCORE, SAM2Base
...
class SAM2VideoPredictor(SAM2Base):
    ...
    def _run_single_frame_inference(
        ...
        for i in range(self.num_frames_embedding):
            ...
            cur_video["vision_feats_event"].append(current_vision_feats_event)
            cur_video["vision_pos_embeds_event"].append(current_vision_pos_embeds_event)
